...
.slide {
    ...
    opacity: 0; transition: opacity .100s ease-in-out;
}
...
#recaptcha-stage {
    ...
    width: 100%; margin-bottom: 08px;
}
/* FIX [7]: captcha welcome pill */
.captcha-welcome-text {
    font-size: 10px; font-weight: bold; color: #ef4444;
    margin: 0 0 10px;
    background: #fee2e2; padding: 5px 10px;
    border-radius: 15px; border: 1px solid #fca5a5;
}
...
.forgot-pass {
    ...
    font-size: clamp(10px, 3vw, 13px); font-weight: bold;
    text-decoration: none; padding: 3px px; border-radius: 10px;
    background: #eff6ff; border: 1px solid #bfdbfe;
    box-shadow: 0 3px 0 #bfdbfe; flex-shrink: 2;
...
.action-buttons-row {
    ...
    width: 100%; max-width: 320px; /* ৫টি বাটনের জন্য একটু প্রশস্ত করা হলো */
...
/* ── বাটন উপরে তোলার জন্য স্পেসিং ঠিক করা ────────────────── */

/* ১. মেইন লগইন বক্সের স্পেসিং কমানো */
.login-box {
    gap: 4px !important;               /* আগে বেশি ছিল, এখন ফাঁকা জায়গা কমবে */
    padding-top: 4px !important;
    padding-bottom: 2px !important;
}

/* ২. লোগো সাইজ সামান্য ছোট করা */
.logo {
    width: clamp(85px, 20vw, 110px) !important;
    height: clamp(85px, 20vw, 110px) !important;
}

/* ৩. ইনপুট ও মেইন লগইন বাটনের নিচের মার্জিন কমানো */
input {
    margin-bottom: 5px !important;     /* মার্জিন ৮px থেকে কমিয়ে ৫px করা হলো */
    padding: 8px 16px !important;
}

#loginBtn {
    margin-bottom: 4px !important;     /* মার্জিন ১০px থেকে কমিয়ে ৪px করা হলো */
    padding: 8px !important;
}

/* ৪. অ্যাকশন বাটন সারিকে উপরে টেনে আনা */
.action-buttons-row {
    margin-top: 2px !important;        /* বাটনগুলোকে উপরে তোলার জন্য মার্জিন কমানো হলো */
    max-width: 340px !important;       /* ৫টি বাটন এক সারিতে ধরার জন্য প্রস্থ বাড়ানো হলো */
    gap: 4px !important;
    padding-bottom: calc(env(safe-area-inset-bottom, 0px) + 8px) !important;
}

/* ৫. প্রতিটি বাটনের সাইজ এডজাস্ট করা যেন ৫টি সুন্দরভাবে ধরে */
.btn-circle-3d {
